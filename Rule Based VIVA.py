...
def wishMe():
    ...
    speak("I am VIVA, your personal desktop assistant. Please let me know how can I help you.")
...
def ScreenShot():
    ...
    image.save('Sample_Screenshot.png', 'PNG')
...
def Calendar():
    ...
    Exit = Button(new, text='Close', fg='Black', bg='grey', command = exit)
